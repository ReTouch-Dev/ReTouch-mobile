        ...
        <View style={styles.form}>
          <Controller control={control} name="full_name"
            render={({ field: { onChange, onBlur, value } }) => (
              <Input label="Full name (optional)" onChangeText={onChange} onBlur={onBlur} value={value ?? ''}
                placeholder="Jane Doe" autoCapitalize="words" leftIcon="person-outline" error={errors.full_name?.message} />
            )} />
          ...
          <Controller control={control} name="confirm"
            render={({ field: { onChange, onBlur, value } }) => (
              <Input label="Confirm password" onChangeText={onChange} onBlur={onBlur} value={value ?? ''}
                placeholder="••••••••" secureTextEntry leftIcon="lock-closed-outline" error={errors.confirm?.message} />
            )} />
          {formError ? (
